...
enum Localization {
    ...
    private static let table: [String: Entry] = [
        ...
        "dashboard.system_info": Entry(it: "Informazioni di sistema", en: "System Information"),
        "dashboard.processor": Entry(it: "Processore", en: "Processor"),
        "dashboard.memory": Entry(it: "Memoria", en: "Memory"),
        "dashboard.storage": Entry(it: "Archiviazione", en: "Storage"),
        "dashboard.battery": Entry(it: "Batteria", en: "Battery"),
        "dashboard.network": Entry(it: "Rete", en: "Network"),
        "dashboard.battery_charging": Entry(it: "in carica", en: "charging"),
        "dashboard.cores_performance": Entry(it: "Performance", en: "Performance"),
        "dashboard.cores_efficiency": Entry(it: "Efficienza", en: "Efficiency"),
        "dashboard.network_unavailable": Entry(it: "Non connesso", en: "Not connected"),
